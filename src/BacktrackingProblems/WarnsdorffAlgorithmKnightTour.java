...
Some definitions:
    ...
    1. A position Q is accessible from a position P if P can move
    to Q by a single Knight’s move, and Q has not yet been visited.
...
Algorithm:
    ...
    4. Return the marked board — each square will be marked with
    the move number on which it is visited.*/
public class WarnsdorffAlgorithmKnightTour {
