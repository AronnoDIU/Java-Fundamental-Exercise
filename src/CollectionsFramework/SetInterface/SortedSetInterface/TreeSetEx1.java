 ...
 * This interface is very similar to the set interface. The only difference is that
 ...
 * Since this class implements the SortedSet,
 * we can instantiate a SortedSet object with this class.
 * <p>
 * For example:
 * <p>
 ...
 * <p>
 * #TreeSet:
 * The TreeSet class uses a Tree for storage. The ordering of the elements is maintained
 * by a set using their natural ordering whether an explicit comparator is provided.
 * This must be consistent with equals if it is to correctly implement the Set interface.
 * It can also be ordered by a Comparator provided at a set creation time,
